...
sap.ui.controller("newstile.NewsTile", {
    onInit : function() {
        ...
        if (!oChipApi.preview.isEnabled()) {
            ...
            this.intervalRefObj = setInterval(function() {
                ...
                that.refreshFeeds();
            }, newstile.NewsTileUtils.getRefreshIntervalConfig(oChipApi));
        }
    },
    ...
    refreshFeeds : function() {
        ...
        if (this._feedsRefreshComplete) {
            ...
            this.model = sap.suite.ui.commons.util.FeedAggregator.getFeeds(newstile.NewsTileUtils.getFeedConfiguration(oChipApi), aInclusionFiltersConfiguration,
